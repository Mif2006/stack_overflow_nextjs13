...
const popularTags = [
  ...
  { _id: 3, name: "Next.js", totalQuestions: 11 },
  { _id: 4, name: "VueJs", totalQuestions: 3 },
  { _id: 5, name: "Valtio", totalQuestions: 2 },
];
  ...
  return (
    <section
      className={`background-light900_dark200 light-border 
        custom-scrollbar sticky right-0 top-[100px] flex h-screen
